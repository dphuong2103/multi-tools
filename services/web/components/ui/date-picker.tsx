...
const DatePicker = ({ selectedDate, setSelectedDate, placeholder, className }: DatePickerProps) => {
    ...
    return (
        <Popover onOpenChange={setIsOpen} open={isOpen}>
            <PopoverTrigger asChild>
                ...
                >
                    {selectedDate ? (
                        format(selectedDate, 'PPP', { locale: locale })
                    ) : (
                        <span>{placeholder ?? "Select your birthday"}</span>
                    )}
